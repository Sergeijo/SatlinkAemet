...
{
    private AemetValuesResult(bool success, string? error, List<MarineZonePrediction>? value)
    {
        Success = success;
    ...
    /// </summary>
    public List<MarineZonePrediction>? Value { get; }
    ...
    public static AemetValuesResult Ok(List<MarineZonePrediction> value)
    {
